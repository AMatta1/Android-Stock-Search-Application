...
public class AdapterFavourite extends RecyclerView.Adapter<AdapterFavourite.ViewHolderForFav> {
    ...
    public AdapterFavourite(ArrayList<String> TICKER_NAME_ARRAY, ArrayList<String> SHARES_ARRAY, ArrayList<String> LAST_PRICE_ARRAY, ArrayList<String> CHANGE_ARRAY, ArrayList<String> UP_DOWN_IMG_ARRAY, Context context) {
    ...
    {
        TICKER_NAME_ARRAY.remove(index);
        SHARES_ARRAY.remove(index);
        LAST_PRICE_ARRAY.remove(index);
        CHANGE_ARRAY.remove(index);
        UP_DOWN_IMG_ARRAY.remove(index);
        notifyItemRemoved(index);
    }
    @NonNull
    @Override
    public ViewHolderForFav onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.homepage_portfolio,parent,false);
        ViewHolderForFav viewHolder = new ViewHolderForFav(view);
        return viewHolder;
    }

    @Override
    public void onBindViewHolder(@NonNull ViewHolderForFav holder, int position) {
    ...
    public class ViewHolderForFav extends RecyclerView.ViewHolder{
        ...
        public ViewHolderForFav(@NonNull View itemView) {
            super(itemView);
